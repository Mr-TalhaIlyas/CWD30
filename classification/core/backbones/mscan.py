...
from core.utils.bricks import DownSample, LayerScale, StochasticDepth, DWConv3x3, NormLayer
...
class MSCANet(nn.Module):
    def __init__(self, in_channnels=3, embed_dims=[32, 64, 460,256], num_classes=1000,
                 ffn_ratios=[4, 4, 4, 4], depths=[3,3,5,2], num_stages=4,
                 ls_init_val=1e-2, drop_path=0.0, as_classifier=False):
