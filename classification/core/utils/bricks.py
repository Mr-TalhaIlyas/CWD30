...
class ConvNormAct(nn.Module):
    ...
    def __init__(self, inChannels, outChannels, kernel_size=3, stride=1, padding='same',
                 dilation=1, groups=1, bias=False, norm_type='sync_bn', act_layer=nn.ReLU):
        super().__init__()
...
class twiceConvNormAct(nn.Module):
    def __init__(self, inChannels, outChannels, kernel=3, stride=1, padding='same',
                 dilation=1, groups=1):
        super().__init__()
        self.conv1 = ConvNormAct(inChannels, outChannels, kernel=kernel, stride=stride, padding=padding,
                                dilation=dilation, groups=groups)
        self.conv2 = ConvNormAct(outChannels, outChannels, kernel=kernel, stride=stride, padding=padding,
                                dilation=dilation, groups=groups)
